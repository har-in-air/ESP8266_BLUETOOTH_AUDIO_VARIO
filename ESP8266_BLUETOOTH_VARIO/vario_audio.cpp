...
#define CROSSOVER_CPS	((int32_t)Nvd.par.cfg.vario.crossoverCps)
#define ZERO_CPS		((int32_t)Nvd.par.cfg.vario.zeroThresholdCps)
#define SINK_CPS		((int32_t)Nvd.par.cfg.vario.sinkThresholdCps)
#define CLIMB_CPS		((int32_t)Nvd.par.cfg.vario.climbThresholdCps)
